...
INPUT_FILE = "data.csv"
OUTPUT_FILE = "delay_vs_time_of_week_binned.png"
BIN_MINUTES = 5  # bucket width
...
def main():
    ...
    ax.fill_between(bin_centers, p25, p75, color=BAND_COLOR, alpha=0.2, linewidth=0, label="25th-75th percentile")
    ax.plot(bin_centers, median, color=LINE_COLOR, linewidth=1.5, label="Median delay")
    ...
    ax.set_title(f"Median delay vs. time of week ({BIN_MINUTES}-min bins)", color=TEXT_COLOR)
