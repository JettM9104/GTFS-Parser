...
AGG = "mean"  # "median" or "mean" -- median tends to collapse to 0 since many delays are exactly 0
BIN_MINUTES = 5  # bucket width along the hour-of-day axis
...
def main():
    ...
    tick_step = max(1, 60 // BIN_MINUTES)  # one tick per hour
