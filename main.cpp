...
week convertDateToWeek(day date) {
    int year = date.year;
...
bool isValid(int tripID, day date) {
    int year = date.year;
    int month = date.month;
    int day = date.day;
...
std::vector<tripSegment> getDayTimesAtStop(day date, const unsigned short int id) {
    int year = date.year;
    int month = date.month;
    int day = date.day;
...
std::vector<tripSegment> getRemainingDayStops(day date, const unsigned short int id, int hour, time24 time) {
    int year = date.year;
    int month = date.month;
    int day = date.day;
